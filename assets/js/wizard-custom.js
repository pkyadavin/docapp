(function (b, c) {
    var a = function (f, e) {
        ...
        this.$finishBtn = $('#' + this.$element[0].id + '-actions').find("button.btn-finish");
        this.$finishBtn.hide();
    ...
    a.prototype = {
        ...
        setState: function () {
            ...
            k.addClass("active");
            var i = k.data().target;
            var si = k.data().search;
            this.$stepContainer.find(".step-pane").removeClass("active");
            this.$searchContainer.find(".step-search").addClass("no-display");
            b(i).addClass("active");
            b(si).removeClass("no-display");
